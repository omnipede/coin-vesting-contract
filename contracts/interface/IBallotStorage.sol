...
contract IBallotStorage {
    ...
    function getBallotVariable(uint256) public view returns (bytes32,uint256,string);
    ...
    function createBallotForVariable(uint256,uint256,address,bytes32,uint256,string) public returns (uint256);
